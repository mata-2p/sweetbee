...
var SWEETBEE = window.SWEETBEE || {};

/* ==================================================
        Formulario de Validacion de Contacto
	================================================== */
	SWEETBEE.ContactForm = function(){
...
/* ==================================================
   Twitter Widget
================================================== */
	SWEETBEE.TwitterWidget = function() {
...
/* ==================================================
   Header Functions
================================================== */
	SWEETBEE.StickyHeader = function() {
...
================================================== */
	var $tallestCol;
	SWEETBEE.pricingTable = function(){
...
$(document).ready(function(){
	SWEETBEE.ContactForm();
	SWEETBEE.scrollToTop();
	SWEETBEE.accordion();
	SWEETBEE.toggle();
	SWEETBEE.toolTip();
	SWEETBEE.TwitterWidget();
	SWEETBEE.galleryflex();
	SWEETBEE.OwlCarousel();
	SWEETBEE.PrettyPhoto();
	SWEETBEE.SuperFish();
	SWEETBEE.Counters();
	SWEETBEE.IsoTope();
	SWEETBEE.StickyHeader();
	SWEETBEE.heroflex();
	SWEETBEE.Password();
	SWEETBEE.pricingTable();
	SWEETBEE.MobileMenu();
...
$(document).ready(function(){
	...
	//* Trigger busqueda Avanzada
	$('.search-advanced-trigger').on("click", function() {
		if ($(this).hasClass('advanced')) {
			$(this).removeClass('advanced');
			$(".advanced-search-row").slideDown();
			$(this).html('Busqueda Basica<i class="fa fa-arrow-up"></i>');
		} else {

			$(this).addClass('advanced');
			$(".advanced-search-row").slideUp();
			$(this).html('Busqueda Avanzada<i class="fa fa-arrow-down"></i>');
		}
		return false;
	});
